<!-- LINKS -->
[history:dds-texture-caching]: https://history.metin2.dev/


# DDS Texture Caching

Usability {octicon}`hash;1em;sd-text-info` :
{bdg-warning-line}`Pointless` {bdg-warning}`Not recommended`

History {octicon}`book;1em;sd-text-info`:
[DDS Texture Caching][history:dds-texture-caching]
|
